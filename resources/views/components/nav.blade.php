...
<nav class="flex justify-between items-center px-8">
    <a href="/" class="flex pb-1">
        ...
        @if (!Request::is('/'))
            <h1 class="text-xl md:text-6xl font-bold uppercase text-white my-auto drop-shadow-md">
    ...
    <!-- Collapsible Dropdown Icon -->
      <div id="dropdown-toggle" class="lg:hidden border border-1 py-2 px-4 rounded-lg cursor-pointer hover:bg-slate-200 hover:border-none hover:text-slate-600 transition duration-300  ">
        <button class="no-spinner focus:outline-none text-2xl">
...
<div id="dropdown-menu" class="hidden shadow-inner  absolute flex justify-end z-50">
    {{-- <div class="bg-black opacity-50 w-full" id="drawer-overlay"></div> --}}
    <div class="bg-white w-full max-w-xs p-4 rounded-sm shadow-lg">
        <!-- Close Button -->
